    ...
    sections: {
      ...
      personas: {
        ...
        carbonExpert: {
          ...
          stat: '1 Minute',
          statDescription: 'Complete LCA Modeling',
          secondStatDescription: '95% Accuracy',
          thirdStatDescription: 'Auto Batch Factor Matching',
          fourthStat: 'DQR+ Industry Data',
          fourthStatDescription: 'Field-level Data Validation',
          painPoints: [
    ...
    sections: {
      ...
      personas: {
        ...
        carbonExpert: {
          ...
          stat: '1分钟',
          statDescription: '完整LCA建模',
          secondStatDescription: '95%准确率',
          thirdStatDescription: '自动批量因子匹配',
          fourthStat: 'DQR+行业数据',
          fourthStatDescription: '字段级数据验证',
          painPoints: [
            '规则和因子不匹配——结果波动±10-20%',
            '大部分数据延迟或错误——按时率低于50%',
